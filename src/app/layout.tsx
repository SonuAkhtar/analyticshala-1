...
export const metadata: Metadata = {
  ...
  keywords: "data analytics, data science, AI, machine learning, SQL, Python, Excel, Tableau, courses, India, Gurgaon",
  authors: [{ name: "AnalyticShala" }],
  openGraph: {
    title: "AnalyticShala — Where Data Careers Are Built",
    description: "Industry-led courses in Data Analytics, Data Science, AI & Web Development. Join 300+ learners.",
