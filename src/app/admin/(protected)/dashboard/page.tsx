  ...
  const quickActions = [
    {
      ...
      sub: "Edit seats, add upcoming workshops",
      path: "/admin/workshops",
    },
    {
      icon: "fas fa-graduation-cap",
      title: "Manage Courses",
      sub: "Edit course details and pricing",
      path: "/admin/courses",
    },
    {
      icon: "fas fa-bullhorn",
      title: "Announcements",
      sub: "Update the site-wide announcement bar",
      path: "/admin/announcements",
    },
    {
      icon: "fas fa-external-link-alt",
      title: "View Site",
      sub: "Preview the site as a visitor",
      path: "/",
      external: true,
    },
  ];
    ...
    <div style={S.page}>
      ...
      {!isSupabaseConfigured && (
        <div style={S.banner}>
          ...
          <div>
            <strong>Supabase not connected yet.</strong> Add{" "}
      ...
      <div style={S.actionsGrid}>
        {quickActions.map((a) => (
          <div
            ...
            style={S.actionCard}
            onClick={() =>
              a.external ? window.open(a.path, "_blank") : router.push(a.path)
            }
            onMouseEnter={(e) =>
                  ...
                  <tr key={w.id}>
                    ...
                    <td style={isLast ? S.tdLast : S.td}>
                      <span
                        style={{
                          ...S.badge,
                          ...(w.seatsLeft != null && w.seatsLeft <= 5
                            ? S.badgeOrange
                            : S.badgeGreen),
                        }}
                      >
                    ...
                    <td style={isLast ? S.tdLast : S.td}>
                      {c.badge ? (
                        <span
                          style={{
                            ...S.badge,
                            ...(badgeMap[c.badgeColor] ?? S.badgeGray),
                          }}
                        >
                          {c.badge}
                        </span>
