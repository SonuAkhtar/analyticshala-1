...
export default function AdminCourses() {
  ...
  const [drawerTab, setDrawerTab] = useState<"basic" | "pricing" | "content">(
    "basic",
  );
  ...
  function handleToggle(courseId: string) {
    ...
    if (!isSupabaseConfigured)
      showToast("Connect Supabase to persist visibility", "error");
  }
              ...
              filtered.map((c, i) => {
                ...
                return (
                  <tr key={c.id}>
                    ...
                    <td style={tdStyle}>
                      <span
                        style={{ ...S.badge, ...GRAY_BADGE, marginLeft: 0 }}
                      >
                        {c.level}
                      </span>
                    </td>
                      ...
                      {c.badge ? (
                        <span
                          style={{
                            ...
                            fontSize: "0.7rem",
                            fontWeight: 600,
                            ...(BADGE_CSS[c.badgeColor] ?? GRAY_BADGE),
                          }}
                        >
                          {c.badge}
                        </span>
                  ...
                  <div style={{ ...S.field, ...S.fieldGrid }}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => upd("modules", Number(e.target.value))}
                      />
                    </div>
                  </div>
                  <div style={S.field}>
                  ...
                  <div style={{ ...S.field, ...S.fieldGrid }}>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => upd("badgeColor", e.target.value)}
                      >
                  ...
                  <div style={{ ...S.field, ...S.fieldGrid }}>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="₹500"
                        onChange={(e) => updReg("regFee", e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={editReg?.price ?? ""}
                        placeholder="₹12,999"
                        onChange={(e) => updReg("price", e.target.value)}
                      />
                    </div>
                  </div>
                  <div style={{ ...S.field, ...S.fieldGrid }}>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="₹19,999"
                        onChange={(e) =>
                          updReg("originalPrice", e.target.value)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updReg("nextBatch", e.target.value)}
                      />
                    </div>
                  </div>
                  <div style={{ ...S.field, ...S.fieldGrid }}>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updReg("batchType", e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updReg("instructor", e.target.value)}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={S.field}>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        upd("skills", e.target.value.split("\n"))
                      }
                    />
                  </div>
                  <div style={S.field}>
                  ...
                  <div style={S.field}>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updReg("whoIsItFor", e.target.value.split("\n"))
                      }
                    />
                  </div>
                </div>
