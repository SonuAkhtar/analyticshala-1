      ...
      <div className={styles.body}>
        ...
        <main className={styles.content}>
          <p className={styles.intro}>
            ...
            of the AnalyticShala website, courses, workshops, and any associated
          ...
          <section className={styles.section} id="enrollment">
            ...
            <ul>
              ...
              <li>
                ...
                access due to medical or personal circumstances, you may submit
          ...
          <section className={styles.section} id="intellectual-property">
            ...
            <p>
              ...
              materials, graphics, logos, software, and the website&apos;s
              design - is the exclusive intellectual property of AnalyticShala
              or its licensed content creators, and is protected under Indian
              and international copyright, trademark, and intellectual property
              laws.
            </p>
            <p>
          ...
          <section className={styles.section} id="certificates">
            ...
            <p>
              ...
              your completion of AnalyticShala&apos;s programme and do not
              constitute a government-recognised degree or professional
              certification.
            </p>
            <p>
          ...
          <section className={styles.section} id="disclaimer">
            ...
            <p>
              ...
              &quot;as available&quot; basis. While we strive to deliver the
              highest quality educational experience, AnalyticShala makes no
            ...
            <ul>
              ...
              <li>
                Course content will meet every learner&apos;s individual
                expectations or career requirements.
              </li>
              <li>
